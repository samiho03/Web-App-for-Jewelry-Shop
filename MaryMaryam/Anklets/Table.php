...
<head>
    ...
    <title>Add Gold Jewellery - Anklets </title>
...
<?php
// Read JSON file
$json_file = 'Anklets.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$anklets = json_decode($json_data, true);
?>

<!-- Display the table -->
<h1>Anklets Details</h1>
<table id="ankletTable">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
        <?php foreach ($anklets as $anklet) { ?>
            <tr>
                <td><?php echo $anklet['id']; ?></td>
                <td><?php echo $anklet['name']; ?></td>
                <td><?php echo $anklet['price']; ?></td>
                <td><img src="<?php echo $anklet['image']; ?>" alt="<?php echo $anklet['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $anklet['category']; ?></td>
...
<a href="Add_Gold_Je_Anklets.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - Anklets </h1>

<form action="delete_anklet.php" method="post">
    <label for="delete_id">Enter ID to delete:</label><br>
    <input type="text" id="delete_id" name="delete_id"><br><br>
    <input type="submit" value="Delete Anklet">
</form>


<h1>Update Gold Jewellery - Anklets </h1>

<form action="update_anklet.php" method="post">
    ...
    <select id="update_category" name="update_category">
             <option value="beaded">Beaded Anklets</option>
            <option value="filigreee">Filigree Anklets</option>
            <option value="classicc">Classic Chain</option>
            <option value="tradi">Traditional</option>
    </select><br><br>
    <input type="submit" value="Update Anklet">
</form>
