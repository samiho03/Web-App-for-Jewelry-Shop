...
<head>
    ...
    <title>Add Gold Jewellery - wedEarrings </title>
...
<?php
// Read JSON file
$json_file = 'WedEarrings.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$wedEarrings = json_decode($json_data, true);
?>

<!-- Display the table -->
<h1>WedEarrings Details</h1>
<table id="wedEarringsTable">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
        <?php foreach ($wedEarrings as $wedEarring) { ?>
            <tr>
                <td><?php echo $wedEarring['id']; ?></td>
                <td><?php echo $wedEarring['name']; ?></td>
                <td><?php echo $wedEarring['price']; ?></td>
                <td><img src="<?php echo $wedEarring['image']; ?>" alt="<?php echo $wedEarring['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $wedEarring['category']; ?></td>
...
<a href="Add_Gold_Je_WedEarrings.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - WedEarrings </h1>

<form action="delete_wedEarring.php" method="post">
    <label for="delete_id">Enter ID to delete:</label><br>
    <input type="text" id="delete_id" name="delete_id"><br><br>
    <input type="submit" value="Delete WedEarring">
</form>


<h1>Update Gold Jewellery - WedEarrings </h1>

<form action="update_wedEarring.php" method="post">
    ...
    <select id="update_category" name="update_category">
             <option value="Wdrop">Drop Earrings</option>
             <option value="stud">Stud</option>
    </select><br><br>
    <input type="submit" value="Update WedEarring">
</form>
