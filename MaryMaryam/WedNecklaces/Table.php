...
<head>
    ...
    <title>Add Gold Jewellery - WedNecklaces </title>
...
<?php
// Read JSON file
$json_file = 'WedNecklace.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$wedNecklaces = json_decode($json_data, true);
?>

<!-- Display the table -->
<h1>WedNecklaces Details</h1>
<table id="wednecklaceTable">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
        <?php foreach ($wedNecklaces as $wedNecklace) { ?>
            <tr>
                <td><?php echo $wedNecklace['id']; ?></td>
                <td><?php echo $wedNecklace['name']; ?></td>
                <td><?php echo $wedNecklace['price']; ?></td>
                <td><img src="<?php echo $wedNecklace['image']; ?>" alt="<?php echo $wedNecklace['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $wedNecklace['category']; ?></td>
...
<a href="Add_Gold_Je_WedNecklaces.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - WedNecklaces </h1>

<form action="delete_wedNecklace.php" method="post">
    <label for="delete_id">Enter ID to delete:</label><br>
    <input type="text" id="delete_id" name="delete_id"><br><br>
    <input type="submit" value="Delete WedNecklace">
</form>


<h1>Update Gold Jewellery - WedNecklaces </h1>

<form action="update_wedNecklace.php" method="post">
    ...
    <select id="update_category" name="update_category">
        <option value="twoLayer">twoLayer</option>
        <option value="tradit">tradit</option>
        <option value="lweight">lweight</option>
    </select><br><br>
    <input type="submit" value="Update WedNecklace">
</form>
