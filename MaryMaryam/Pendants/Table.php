...
<head>
    ...
    <title>Add Gold Jewellery - Pendants </title>
...
<?php
// Read JSON file
$json_file = 'Pendants.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$pendants = json_decode($json_data, true);
?>

<!-- Display the table -->
<h1>Pendants Details</h1>
<table id="pendantsTable">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
        <?php foreach ($pendants as $pendant) { ?>
            <tr>
                <td><?php echo $pendant['id']; ?></td>
                <td><?php echo $pendant['name']; ?></td>
                <td><?php echo $pendant['price']; ?></td>
                <td><img src="<?php echo $pendant['image']; ?>" alt="<?php echo $pendant['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $pendant['category']; ?></td>
...
<a href="Add_Gold_Je_Pendants.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - Pendants </h1>

<form action="delete_pendants.php" method="post">
    <label for="delete_id">Enter ID to delete:</label><br>
    <input type="text" id="delete_id" name="delete_id"><br><br>
    <input type="submit" value="Delete Pendant">
</form>


<h1>Update Gold Jewellery -  Pendants </h1>

<form action="update_pendants.php" method="post">
    ...
    <select id="update_category" name="update_category">
            ...
            <option value="cross">Cross Pendant</option>
            <option value="ini">Initial</option>
            <option value="gemP">Gemstone Pendant</option>
            <option value="floralP">Floral</option>
    </select><br><br>
    <input type="submit" value="Update Pendant">
</form>
