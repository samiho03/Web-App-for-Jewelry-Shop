...
<head>
    ...
    <title>Add Gold Jewellery - AuBracelets </title>
...
<?php
// Read JSON file
$json_file = 'AuBracelets.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$auBracelets = json_decode($json_data, true);
?>

<!-- Display the table -->
<h1>AuBracelets Details</h1>
<table id="auBraceletTable">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
        <?php foreach ($auBracelets as $auBracelet) { ?>
            <tr>
                <td><?php echo $auBracelet['id']; ?></td>
                <td><?php echo $auBracelet['name']; ?></td>
                <td><?php echo $auBracelet['price']; ?></td>
                <td><img src="<?php echo $auBracelet['image']; ?>" alt="<?php echo $auBracelet['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $auBracelet['category']; ?></td>
...
<a href="Add_Gold_Je_AuBracelets.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - AuBracelets </h1>

<form action="delete_auBracelet.php" method="post">
...
<h1>Update Gold Jewellery - AuBracelets </h1>

<form action="update_auBracelet.php" method="post">
    ...
    <input type="submit" value="Update AuBracelet">
</form>
