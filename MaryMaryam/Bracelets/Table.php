...
<head>
    ...
    <title>Add Gold Jewellery - Bracelets </title>
...
<?php
// Read JSON file
$json_file = 'Bracelets.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$bracelets = json_decode($json_data, true);
?>

<!-- Display the table -->
<h1>Bracelets Details</h1>
<table id="braceletTable">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
        <?php foreach ($bracelets as $bracelet) { ?>
            <tr>
                <td><?php echo $bracelet['id']; ?></td>
                <td><?php echo $bracelet['name']; ?></td>
                <td><?php echo $bracelet['price']; ?></td>
                <td><img src="<?php echo $bracelet['image']; ?>" alt="<?php echo $bracelet['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $bracelet['category']; ?></td>
...
<a href="Add_Gold_Je_Bracelets.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - Bracelets </h1>
...
<form action="delete_bracelet.php" method="post">
    ...
    <input type="submit" value="Delete Bracelet">
</form>


<h1>Update Gold Jewellery - Bracelets </h1>

<form action="update_bracelet.php" method="post">
    ...
    <select id="update_category" name="update_category">
            ...
            <option value="fancy">Fancy Floral</option>
            <option value="cartier">Cartier</option>
            <option value="studded">Crafted and Studded</option>
    </select><br><br>
    <input type="submit" value="Update Bracelet">
</form>
