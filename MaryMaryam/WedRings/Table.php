...
<head>
    ...
    <title>Add Gold Jewellery - WedRings </title>
...
<?php
// Read JSON file
$json_file = 'WedRings.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$wedRings = json_decode($json_data, true);
?>

<!-- Display the table -->
<h1>WedRings Details</h1>
<table id="wedRingTable">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
        <?php foreach ($wedRings as $wedRing) { ?>
            <tr>
                <td><?php echo $wedRing['id']; ?></td>
                <td><?php echo $wedRing['name']; ?></td>
                <td><?php echo $wedRing['price']; ?></td>
                <td><img src="<?php echo $wedRing['image']; ?>" alt="<?php echo $wedRing['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $wedRing['category']; ?></td>
...
<a href="Add_Gold_Je_WedRings.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - WedRings </h1>

<form action="delete_wedRing.php" method="post">
    <label for="delete_id">Enter ID to delete:</label><br>
    <input type="text" id="delete_id" name="delete_id"><br><br>
    <input type="submit" value="Delete WedRing">
</form>


<h1>Update Gold Jewellery - WedRings </h1>

<form action="update_wedRing.php" method="post">
    ...
    <input type="submit" value="Update WedRing">
</form>
