...
<head>
    ...
    <title>Add Gold Jewellery - WedBangles </title>
...
<?php
// Read JSON file
$json_file = 'WedBangles.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$wedBangles = json_decode($json_data, true);
?>

<!-- Display the table -->
<h1>WedBangles Details</h1>
<table id="wedBangleTable">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
        <?php foreach ($wedBangles as $wedBangle) { ?>
            <tr>
                <td><?php echo $wedBangle['id']; ?></td>
                <td><?php echo $wedBangle['name']; ?></td>
                <td><?php echo $wedBangle['price']; ?></td>
                <td><img src="<?php echo $wedBangle['image']; ?>" alt="<?php echo $wedBangle['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $wedBangle['category']; ?></td>
...
<a href="Add_Gold_Je_WedBangles.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - WedBangles </h1>

<form action="delete_wedBangle.php" method="post">
    <label for="delete_id">Enter ID to delete:</label><br>
    <input type="text" id="delete_id" name="delete_id"><br><br>
    <input type="submit" value="Delete WedBangle">
</form>


<h1>Update Gold Jewellery - WedBangles </h1>

<form action="update_wedBangle.php" method="post">
    ...
    <select id="update_category" name="update_category">
                <option value="Wfloral">Floral</option>
              <option value="Wkada">Kada Bangles</option>
    </select><br><br>
    <input type="submit" value="Update WedBangle">
</form>
