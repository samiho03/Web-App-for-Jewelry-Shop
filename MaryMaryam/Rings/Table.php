...
<head>
    ...
    <title>Add Gold Jewellery - Rings </title>
...
<?php
// Read JSON file
$json_file = 'Rings.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$rings = json_decode($json_data, true);
?>
...
<table id="ringTable">
    ...
    <tbody>
        <?php foreach ($rings as $ring) { ?>
            <tr>
                <td><?php echo $ring['id']; ?></td>
                <td><?php echo $ring['name']; ?></td>
                <td><?php echo $ring['price']; ?></td>
                <td><img src="<?php echo $ring['image']; ?>" alt="<?php echo $ring['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $ring['category']; ?></td>
...
<a href="Add_Gold_Je_Rings.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - Rings</h1>

<form action="delete_rings.php" method="post">
...
<h1>Update Gold Jewellery - Rings </h1>

<form action="update_ring.php" method="post">
    ...
    <select id="update_category" name="update_category">
            ...
            <option value="open">Openness</option>
            <option value="cockt">Cocktail</option>
    </select><br><br>
    <input type="submit" value="Update Ring">
</form>
