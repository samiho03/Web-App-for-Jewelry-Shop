...
<head>
    ...
    <title>Add Gold Jewellery - Bangles </title>
...
<?php
// Read JSON file
$json_file = 'Bangles.json';
$json_data = file_get_contents($json_file);
// Decode JSON data into an associative array
$bangles = json_decode($json_data, true);
?>

<!-- Display the table -->
<h1>Bangles Details</h1>
<table id="bangleTable">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
        <?php foreach ($bangles as $bangle) { ?>
            <tr>
                <td><?php echo $bangle['id']; ?></td>
                <td><?php echo $bangle['name']; ?></td>
                <td><?php echo $bangle['price']; ?></td>
                <td><img src="<?php echo $bangle['image']; ?>" alt="<?php echo $bangle['name']; ?>" style="max-width: 100px;"></td>
                <td><?php echo $bangle['category']; ?></td>
...
<a href="Add_Gold_Je_Bangles.php" class="add-product-button">
    <i class="fa fa-plus-circle"></i> Add Product
</a>


<h1>Delete Gold Jewellery - Bangles </h1>

<form action="delete_bangle.php" method="post">
    <label for="delete_id">Enter ID to delete:</label><br>
    <input type="text" id="delete_id" name="delete_id"><br><br>
    <input type="submit" value="Delete Bangle">
</form>


<h1>Update Gold Jewellery - Bangles </h1>

<form action="update_bangle.php" method="post">
    ...
    <select id="update_category" name="update_category">
            <option value="classic">Classic Solid</option>
             <option value="kada">Kada Bangle</option>
             <option value="roman">Roman Gold</option>
             <option value="filigree">Filigree Gold</option>
             <option value="layered">Layered Gold</option>
    </select><br><br>
    <input type="submit" value="Update Bangle">
</form>
